...
public class Meeting {
	...
	public String getMeeting_kakaotalk() {
		return meeting_kakaotalk;
	}
	public void setMeeting_kakaotalk(String meeting_kakaotalk) {
		this.meeting_kakaotalk = meeting_kakaotalk;
	}
